...
settings = {
    'foldername':"multichannel",            #MAIN FOLDER FOR OPTIMIZATION RUN
    ...
    'weighting_x':[-1,10.75],                 #OPTIMIZATION FOR TARGET (RECTANGLE) AREA, HERE X LIMITS
    'weighting_y':[-4,-0],                #OPTIMIZATION FOR TARGET (RECTANGLE) AREA, HERE Y LIMITS
    ...
    'nr_configs':200,                       #DESIRED NUMBER OF CONFIGURATIONS IN FINAL OPTIMIZED SCHEME
